...
- `gold_to_bi_export` as the stable single-file Parquet BI snapshot stage
...
- The current recommended BI delivery path is the exported Parquet snapshot, not a live managed BI service.
